function [G,debuu,sfpro]=nn_unlearnedFourier(phi,...
    J_ext,...
    J_0,...
    Amp,...
    K,...
...
if dosfpr
    ...
    [sfpr.mu_out, sfpr.sig_out,sfpr.beta_out,sfpr.beta_add,Amp]=...
        solveFixedPointRing_Erf(phi,J_ext,J_0,J_2,1,1,K,psi_vec);
end
