% trying to smooth the graph at g=1.0
% cx- correlation of x
% Cr - correaltion of rates
% sigx- sd of x
clear;
Amp=1.2;
g_vec=[0.2,0.5,1.0,1.6,1.8];%[0.2, 0.5,1.0];%[0.01 0.1:0.1:2.2];
M_vec=[4,6,8,10,12,14];
sim_resolution=120*7;
ind=0;
...
%%
save(strrep(['save_mft_corr_simres',sim_resolution,'_g_',num2str(g),],'.','p'));
end
figure;%(128)
% plot(g_vec,G1p)
hold all;
