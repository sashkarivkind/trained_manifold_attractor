...
%%
d0=z_epsi0{rr}-f_ol_tag;
d0abs=abs([1,1i]*d0);
psi_0=angle([1,1i]*z_epsi0{rr});
rho_0=abs([1,1i]*z_epsi0{rr});

d0p1=z_epsi0p1{rr}-f_ol_tag;
d0p1abs=abs([1,1i]*d0p1);
psi_0p1=angle([1,1i]*z_epsi0p1{rr});
rho_0p1=abs([1,1i]*z_epsi0p1{rr});

du=z_epsi{rr}-f_ol_tag;
duabs=abs([1,1i]*du);
psiu=angle([1,1i]*z_epsi{rr});
rhou=abs([1,1i]*z_epsi{rr});
