...
%                 x_ic(:,icic)=2*cos(psi_ic'-thet_ic(icic))+4*randn(net.N,1);
                
                tic;
                icic
                [xdeltaRot,zdeltaRot{icic},xrecdeltaRot]=fast_conv_to_fp_extended(net,[],...
                    struct('xinit',x(:,1),...
                    'ol',0,...
                    'tmax',tmax,...
                    'dt',dt,...
...
%                 [xdeltaFall,zdeltaFall{icic},xrecdeltaFall]=fast_conv_to_fp_extended(net,[],...
%                     struct('xinit',x_ic(:,icic),...
%                     'ol',0,...
%                     'tmax',tmax,...
%                     'dt',dt,...
%                     'u_in',0*u_in,...
%                     'save_neurons',[1:200:net.N]));
            ...
            save(['FallRotDt1_ResultsM_3_N',num2str(net.N),...
