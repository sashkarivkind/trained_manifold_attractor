...
xbmp = fast_conv_to_fp(net,sim.f_ol+[0;0.001]*ones(1,size(sim.f_ol,2)),...
    struct('ol',1));
...
if saveFlag
    ...
    result.with_learningBMP.z_ol = net.wout'*sim.r;
    [x_cl,result.with_learningBMP.z_cl]=fast_conv_to_fp_extended(net,[],...
        struct('xinit',x,...
        'ol',0,...
        'tmax',tmax,...
        'dt',dt));
