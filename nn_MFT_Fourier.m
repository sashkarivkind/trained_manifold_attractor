function [G,debuu,sfpro]=nn_MFT_Fourier(phi,...
    J_ext,...
    J_0,...
    Amp,...
    K,...
...
crr= sfpr.beta_out/sfpr.sig_out^2/J_0^2;
crr_old_and_irrelevant=crr_fun(sfpr.sig_out,sfpr.beta_out,psi_vec,Amp,phi);
